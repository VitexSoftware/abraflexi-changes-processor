...
.\"
.\" First parameter, ABRAFLEXI-CHANGES-PROCESSOR, should be all caps
.\" Second parameter, SECTION, should be 1-8, maybe w/ subsection
.\" other parameters are allowed: see man(7), man(1)
.TH ABRAFLEXI-CHANGES-PROCESSOR SECTION "07 Jun 2022"
...
.SH NAME
abraflexi-changes-processor \- program to do something
.SH SYNOPSIS
.B abraflexi-changes-processor
.RI [ options ] " files" ...
.br
.B bar
.RI [ options ] " files" ...
...
.\" respectively.
\fBabraflexi-changes-processor\fP is a program that...
.SH OPTIONS
